...
Szukamy wtedy $\tilde V_0(X_0)=V_0(X_0)$. Czynnik $D_{i1,i+1}$ jest współczynnikiem dyskonta pomiędzy momentem $t_{i+1}$ a $t_{i}$ , czyli wartością, w momencie $t_{i}$, jednego dolara wypłacanego w przyszłej chwili $t_{i+1}$. Dla prostego modelu ze stałą stopą procentową $r$, jest to po prostu $\exp(-r(t_{i+1}-t_{i}))$.
