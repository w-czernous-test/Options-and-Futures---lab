...
Pomocny, w zrozumieniu definicji $\hat V_i^{j_1\cdots j_i}$, będzie przykład na poniższym rysunku, gdzie przyjęto dla uproszczenia $r=0$, $b=3$, oraz funkcję wypłaty $\tilde h_i(x) = (x - 100)_+$ (a więc dla opcji kupna):
