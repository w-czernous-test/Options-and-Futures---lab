...
Wyznaczyć aproksymację funkcji $V_{m-1}$ na przedziale $[0,100]$,
dla h=0.01 oraz dla wartości sigma, r, K, jak wyżej. Porównać wynik z postacią analityczną na wykresie.
```{r}
